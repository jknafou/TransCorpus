...
This module defines the data models used throughout the TransCorpus project. These models
are built using Pydantic to ensure validation of input data and enforce type safety.

Models:
    - DataEntry: Represents a single entry in a domain configuration.
    - DomainData: Represents the configuration for a specific domain, including its
      database, corpus, ID, and language.
...
Typical usage example:
    ...
    data_entry = DataEntry(file="http://example.com/file", demo="http://example.com/demo")
...
class DataEntry(BaseModel):
    ...
    Attributes:
        ...
        demo (Optional[HttpUrl]): An optional URL pointing to a demo version of the file.
